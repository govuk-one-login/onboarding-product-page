...
import {createFieldMap, InputType, RadiosInput} from "../types/form-fields";

const requiredFields = createFieldMap([
    {name: "support", inputType: InputType.Text, missingValueMessage: "Enter your name"},
    {name: "organisation-name", inputType: InputType.Text, missingValueMessage: "Enter your organisation name"},
    {name: "email", inputType: InputType.Email, missingValueMessage: "Enter your government email address"},
    {name: "service-name", inputType: InputType.Text, missingValueMessage: "Enter the name of your service"},
    {name: "mailing-list", inputType: InputType.Radios, missingValueMessage: "Select if you’d like to join the mailing list or not"},
    new RadiosInput("mailing-list", "Select if you’d like to join the mailing list or not", [
        {text: "Yes", value: "yes", id: "mailing-list-yes"},
        {text: "No", value: "no", id: "mailing-list-no"}
    ])
]);
