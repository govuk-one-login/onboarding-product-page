...
import {processPrototypeEmailForm} from "../controllers/prototype";
...
router.post("/documentation/end-to-end-prototype/enter-email-address", processPrototypeEmailForm);
