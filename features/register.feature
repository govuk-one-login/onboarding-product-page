Feature: A form so users can register to get started with GOV.UK One Login
  ...
  Rule: The user tries to select and submit an Approximate number of users each year when registering to get started with GOV.UK One Login
    Scenario: The user does not enter any value into the Approximate number of users field
      When they try to submit Approximate number of users ""
      Then the error message with the text "Enter the number of users you expect annually" must be displayed for the approximate number of users field
    Scenario: The user enters an invalid number in the Approximate number of users field
      When they try to submit Approximate number of users "five"
      Then the error message with the text "Enter a valid number" must be displayed for the approximate number of users field
