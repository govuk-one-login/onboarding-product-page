Feature: User journeys page
  ...
  @wip # destination page does not exist
  Scenario: The user wants to view the Account Creation journey
    ...
    Then they should be directed to a page with the title "Creating an account at the start of your service journey"
  ...
  Scenario: The user wants to view  the Save and Resume journey
    ...
    Then they should be directed to a page with the title "GOV.UK Sign In: Save progress and come back later"
